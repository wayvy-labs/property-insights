...
# Contributing to DreamProperty

Welcome, and thank you for considering contributing to **DreamProperty**! 
...
2. **Clone your fork** locally:  
   ```bash
   git clone https://github.com/wayvy-labs/property-insights.git
...
DreamProperty uses modern JavaScript tools and frameworks. Make sure you have `Node.js` and `npm` installed.
